        ...
        <Container fluid>
          <Row style={{marginTop:"5px"}}>
            <Col xs="auto" style={{ height: "50px" }}>
              <img className="Icon" src={JobRecord_Icon.imgAddess} style={{ height: "80%", marginTop: "15%" }} onClick={()=>toHome()}/>
            </Col>
            <Col >
            ...
            <Col xs={{ offset: 7 }} style={{textAlign:"right"}}>
              <Button onClick={()=>handleSignOut()} style={{ marginTop: "10px", background:"none",border:"none" }}>
